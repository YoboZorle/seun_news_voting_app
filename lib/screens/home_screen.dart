...
class _HomeScreenState extends State<HomeScreen>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('🇳🇬 NaijaNews', style: TextStyle(fontSize: 18)),
        centerTitle: true,
          ...
          tabs: categories.map((category) {
            return Tab(
              child: Row(
                ...
                children: [
                  Text(
                    AppTheme.categoryEmojis[category] ?? '📰',
...
class NewsCard extends StatelessWidget {
  ...
  const NewsCard({Key? key, required this.news, required this.newsProvider})
    : super(key: key);
                ...
                Positioned(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color:
                          AppTheme.categoryColors[news.category] ??
