...
List<PoliticalContestant> generateSampleContestants() {
  return [
    PoliticalContestant(
      ...
      imageUrl: 'https://via.placeholder.com/200x200?text=Ambode',
    ...
    PoliticalContestant(
      ...
      imageUrl: 'https://via.placeholder.com/200x200?text=Olajide',
      position: 'Presidential Candidate',
    ),
    PoliticalContestant(
      id: 'contestant_3',
      ...
      imageUrl: 'https://via.placeholder.com/200x200?text=Adeyemi',
      position: 'Presidential Candidate',
    ),
    PoliticalContestant(
      id: 'contestant_4',
      ...
      imageUrl: 'https://via.placeholder.com/200x200?text=Okafor',
